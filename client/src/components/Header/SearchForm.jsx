    ...
    return (
        <div css={[containerStyle, cssProp]} {...rest}>
            <form onSubmit={handleSubmit} className="relative inline w-full pr-4">
                ...
                <input className="w-full pl-7 h-8 border rounded-[10px] text-l animate-[myfirst_5s_infinite]" type="text" value={searchField} onChange={(e) => setSearchField(e.target.value)} placeholder="Sök produkt" />
            </form>
        </div>
    );
}